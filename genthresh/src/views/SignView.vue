<template>
    ...
    <div class="flex justify-center mb-4">
      <EditableArea v-model="privKey" placeholderValue="Import or enter private key..." class="w-4/5 break-words border-2 rounded-xl border-yellow-800 text-2xl p-8 xl:w-3/5"></EditableArea>
    </div>
